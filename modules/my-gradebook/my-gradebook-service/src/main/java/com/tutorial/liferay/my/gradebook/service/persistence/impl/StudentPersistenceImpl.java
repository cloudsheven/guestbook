...
import com.tutorial.liferay.my.gradebook.exception.NoSuchStudentException;
import com.tutorial.liferay.my.gradebook.model.Student;
import com.tutorial.liferay.my.gradebook.model.StudentTable;
import com.tutorial.liferay.my.gradebook.model.impl.StudentImpl;
import com.tutorial.liferay.my.gradebook.model.impl.StudentModelImpl;
import com.tutorial.liferay.my.gradebook.service.persistence.StudentPersistence;
import com.tutorial.liferay.my.gradebook.service.persistence.StudentUtil;
...
public class StudentPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByG_G_C;
	private FinderPath _finderPathWithoutPaginationFindByG_G_C;
	private FinderPath _finderPathCountByG_G_C;

	/**
	 * Returns all the students where groupId = &#63; and myGradebookId = &#63; and courseId = &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<Student> findByG_G_C(
		long groupId, long myGradebookId, long courseId) {

		return findByG_G_C(
			groupId, myGradebookId, courseId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the students where groupId = &#63; and myGradebookId = &#63; and courseId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StudentModelImpl</code>.
	 * </p>
	...
	@Override
	public List<Student> findByG_G_C(
		long groupId, long myGradebookId, long courseId, int start, int end) {

		return findByG_G_C(groupId, myGradebookId, courseId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the students where groupId = &#63; and myGradebookId = &#63; and courseId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StudentModelImpl</code>.
	 * </p>
	...
	public List<Student> findByG_G_C(
		...
		return findByG_G_C(
			groupId, myGradebookId, courseId, start, end, orderByComparator,
			true);
	}
	...
	public List<Student> findByG_G_C(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByG_G_C;
				finderArgs = new Object[] {groupId, myGradebookId, courseId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByG_G_C;
			finderArgs = new Object[] {
				groupId, myGradebookId, courseId, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_G_C_GROUPID_2);

			sb.append(_FINDER_COLUMN_G_G_C_MYGRADEBOOKID_2);

			sb.append(_FINDER_COLUMN_G_G_C_COURSEID_2);
	...
	/**
	 * Returns the first student in the ordered set where groupId = &#63; and myGradebookId = &#63; and courseId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param myGradebookId the my gradebook ID
	 * @param courseId the course ID
	 ...
	 */
	@Override
	public Student findByG_G_C_First(
			long groupId, long myGradebookId, long courseId,
			OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchByG_G_C_First(
			groupId, myGradebookId, courseId, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchByG_G_C_First(
		long groupId, long myGradebookId, long courseId,
		OrderByComparator<Student> orderByComparator) {

		List<Student> list = findByG_G_C(
			groupId, myGradebookId, courseId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last student in the ordered set where groupId = &#63; and myGradebookId = &#63; and courseId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param myGradebookId the my gradebook ID
	 * @param courseId the course ID
	 ...
	 */
	@Override
	public Student findByG_G_C_Last(
			long groupId, long myGradebookId, long courseId,
			OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchByG_G_C_Last(
			groupId, myGradebookId, courseId, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchByG_G_C_Last(
		long groupId, long myGradebookId, long courseId,
		OrderByComparator<Student> orderByComparator) {

		int count = countByG_G_C(groupId, myGradebookId, courseId);
		...
		List<Student> list = findByG_G_C(
			groupId, myGradebookId, courseId, count - 1, count,
			orderByComparator);
	...
	/**
	 * Returns the students before and after the current student in the ordered set where groupId = &#63; and myGradebookId = &#63; and courseId = &#63;.
	 *
	 * @param studentId the primary key of the current student
	 * @param groupId the group ID
	 * @param myGradebookId the my gradebook ID
	 ...
	 */
	@Override
	public Student[] findByG_G_C_PrevAndNext(
			long studentId, long groupId, long myGradebookId, long courseId,
			OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {
		...
		try {
			...
			array[0] = getByG_G_C_PrevAndNext(
				session, student, groupId, myGradebookId, courseId,
				orderByComparator, true);

			array[1] = student;

			array[2] = getByG_G_C_PrevAndNext(
				session, student, groupId, myGradebookId, courseId,
	...
	protected Student getByG_G_C_PrevAndNext(
		Session session, Student student, long groupId, long myGradebookId,
		long courseId, OrderByComparator<Student> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the students where groupId = &#63; and myGradebookId = &#63; and courseId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param myGradebookId the my gradebook ID
	 * @param courseId the course ID
	 */
	@Override
	public void removeByG_G_C(long groupId, long myGradebookId, long courseId) {
		for (Student student :
				findByG_G_C(
					groupId, myGradebookId, courseId, QueryUtil.ALL_POS,
					QueryUtil.ALL_POS, null)) {
	...
	/**
	 * Returns the number of students where groupId = &#63; and myGradebookId = &#63; and courseId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param myGradebookId the my gradebook ID
	 * @param courseId the course ID
	 ...
	 */
	@Override
	public int countByG_G_C(long groupId, long myGradebookId, long courseId) {
		FinderPath finderPath = _finderPathCountByG_G_C;

		Object[] finderArgs = new Object[] {groupId, myGradebookId, courseId};
	...
	private static final String _FINDER_COLUMN_G_G_C_GROUPID_2 =
		"student.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_G_C_MYGRADEBOOKID_2 =
		"student.myGradebookId = ? AND ";

	private static final String _FINDER_COLUMN_G_G_C_COURSEID_2 =
		"student.courseId = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_G_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_G_C",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"groupId", "myGradebookId", "courseId"}, true);

		_finderPathWithoutPaginationFindByG_G_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_G_C",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			new String[] {"groupId", "myGradebookId", "courseId"}, true);

		_finderPathCountByG_G_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_G_C",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			new String[] {"groupId", "myGradebookId", "courseId"}, false);
