...
import com.tutorial.liferay.my.gradebook.exception.NoSuchCourseException;
import com.tutorial.liferay.my.gradebook.model.Course;
import com.tutorial.liferay.my.gradebook.model.CourseTable;
import com.tutorial.liferay.my.gradebook.model.impl.CourseImpl;
import com.tutorial.liferay.my.gradebook.model.impl.CourseModelImpl;
import com.tutorial.liferay.my.gradebook.service.persistence.CoursePersistence;
import com.tutorial.liferay.my.gradebook.service.persistence.CourseUtil;
 ...
 * @generated
 */
@Component(service = {CoursePersistence.class, BasePersistence.class})
public class CoursePersistenceImpl
	 ...
	 */
	@Override
	public List<Course> findByG_G(long groupId, long myGradebookId) {
		return findByG_G(
			groupId, myGradebookId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<Course> findByG_G(
		...
		return findByG_G(groupId, myGradebookId, start, end, null);
	}
	...
	public List<Course> findByG_G(
		...
		return findByG_G(
			groupId, myGradebookId, start, end, orderByComparator, true);
	}
	...
	public List<Course> findByG_G(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {groupId, myGradebookId};
			}
		}
		else if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Course course : list) {
					if ((groupId != course.getGroupId()) ||
						(myGradebookId != course.getMyGradebookId())) {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_G_MYGRADEBOOKID_2);
	...
	public Course fetchByG_G_First(
		...
		List<Course> list = findByG_G(
			groupId, myGradebookId, 0, 1, orderByComparator);
	...
	public Course fetchByG_G_Last(
		...
		int count = countByG_G(groupId, myGradebookId);
		...
		List<Course> list = findByG_G(
			groupId, myGradebookId, count - 1, count, orderByComparator);
	...
	public Course[] findByG_G_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_G_PrevAndNext(
				session, course, groupId, myGradebookId, orderByComparator,
				true);
	...
	protected Course getByG_G_PrevAndNext(
		Session session, Course course, long groupId, long myGradebookId,
		OrderByComparator<Course> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeByG_G(long groupId, long myGradebookId) {
		for (Course course :
				findByG_G(
					groupId, myGradebookId, QueryUtil.ALL_POS,
	 ...
	 */
	@Override
	public int countByG_G(long groupId, long myGradebookId) {
		FinderPath finderPath = _finderPathCountByG_G;

		Object[] finderArgs = new Object[] {groupId, myGradebookId};
	...
	private static final String _FINDER_COLUMN_G_G_MYGRADEBOOKID_2 =
		"course.myGradebookId = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_G = new FinderPath(
			...
			new String[] {"groupId", "myGradebookId"}, true);
		...
		_finderPathCountByG_G = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"groupId", "myGradebookId"}, false);
	...
	@Reference
	private CourseModelArgumentsResolver _courseModelArgumentsResolver;
