...
public class StudentUtil {
	 ...
	 * @return the matching students
	 */
	public static List<Student> findByG_G_C(
		long groupId, long myGradebookId, long courseId) {

		return getPersistence().findByG_G_C(groupId, myGradebookId, courseId);
	}
	...
	public static List<Student> findByG_G_C(
		...
		return getPersistence().findByG_G_C(
			groupId, myGradebookId, courseId, start, end);
	}
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByG_G_C_First(
			long groupId, long myGradebookId, long courseId,
			OrderByComparator<Student> orderByComparator)
		throws com.tutorial.liferay.my.gradebook.exception.
			NoSuchStudentException {

		return getPersistence().findByG_G_C_First(
	 ...
	 * @return the first matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByG_G_C_First(
		long groupId, long myGradebookId, long courseId,
		OrderByComparator<Student> orderByComparator) {

		return getPersistence().fetchByG_G_C_First(
			groupId, myGradebookId, courseId, orderByComparator);
	}
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByG_G_C_Last(
			long groupId, long myGradebookId, long courseId,
			OrderByComparator<Student> orderByComparator)
		throws com.tutorial.liferay.my.gradebook.exception.
			NoSuchStudentException {

		return getPersistence().findByG_G_C_Last(
			groupId, myGradebookId, courseId, orderByComparator);
	}
	 ...
	 * @return the last matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByG_G_C_Last(
		long groupId, long myGradebookId, long courseId,
		OrderByComparator<Student> orderByComparator) {

		return getPersistence().fetchByG_G_C_Last(
			groupId, myGradebookId, courseId, orderByComparator);
	}
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public static Student[] findByG_G_C_PrevAndNext(
			long studentId, long groupId, long myGradebookId, long courseId,
			OrderByComparator<Student> orderByComparator)
		throws com.tutorial.liferay.my.gradebook.exception.
			NoSuchStudentException {

		return getPersistence().findByG_G_C_PrevAndNext(
			studentId, groupId, myGradebookId, courseId, orderByComparator);
	}
	 ...
	 * @param courseId the course ID
	 */
	public static void removeByG_G_C(
		long groupId, long myGradebookId, long courseId) {

		getPersistence().removeByG_G_C(groupId, myGradebookId, courseId);
	}
	 ...
	 * @return the number of matching students
	 */
	public static int countByG_G_C(
		long groupId, long myGradebookId, long courseId) {

		return getPersistence().countByG_G_C(groupId, myGradebookId, courseId);
	}
