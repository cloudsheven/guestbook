...
/**
 * The table class for the &quot;MYGDB_Student&quot; database table.
 *
 * @author Andrea Luzzi
 * @see Student
 * @generated
...
public class StudentTable extends BaseTable<StudentTable> {
	...
	public final Column<StudentTable, Date> birthday = createColumn(
	...
	public final Column<StudentTable, Long> myGradebookId = createColumn(
		"myGradebookId", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);
	public final Column<StudentTable, Long> courseId = createColumn(
		"courseId", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);
	public final Column<StudentTable, Date> enrollDate = createColumn(
		"enrollDate", Date.class, Types.TIMESTAMP, Column.FLAG_DEFAULT);

	private StudentTable() {
		super("MYGDB_Student", StudentTable::new);
	}
