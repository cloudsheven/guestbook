...
/**
 * The table class for the &quot;MYGDB_Course&quot; database table.
 *
 * @author Andrea Luzzi
 * @see Course
 * @generated
...
public class CourseTable extends BaseTable<CourseTable> {
	...
	public final Column<CourseTable, Long> myGradebookId = createColumn(
	...
	public final Column<CourseTable, String> topic = createColumn(
		"topic", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	...
	private CourseTable() {
		super("MYGDB_Course", CourseTable::new);
	}
