...
/**
 * Provides the local service interface for Gradebook. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Andrea Luzzi
 * @see GradebookLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GradebookLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.tutorial.liferay.my.gradebook.service.impl.GradebookLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the gradebook local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link GradebookLocalServiceUtil} if injection and service tracking are not available.
	 */
