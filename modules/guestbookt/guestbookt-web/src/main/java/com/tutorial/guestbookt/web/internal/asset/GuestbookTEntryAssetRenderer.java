...
public class GuestbookTEntryAssetRenderer 
	extends BaseJSPAssetRenderer<GuestbookTEntry> {
	
    public GuestbookTEntryAssetRenderer(
    		GuestbookTEntry entry, ModelResourcePermission<GuestbookTEntry> modelResourcePermission) {
    ...
    {
        try {
            return _guestbookTEntryModelResourcePermission.contains(
    ...
    @Override
    public GuestbookTEntry getAssetObject() {
        return _entry;
    }
    ...
    public String getJspPath(HttpServletRequest request, String template) {
        ...
        if (template.equals(TEMPLATE_FULL_CONTENT)) {
            request.setAttribute("gbt_entry", _entry);
    ...
    public PortletURL getURLEdit(LiferayPortletRequest liferayPortletRequest,
        ...
        portletURL.setParameter("mvcPath", "/guestbookt/edit_entry.jsp");
    ...
    public String getURLViewInContext(LiferayPortletRequest liferayPortletRequest,
        ...
        try {
            ...
            portletURL.setParameter("mvcPath", "/guestbookt/view_entry.jsp");
            portletURL.setParameter("entryId", String.valueOf(_entry.getEntryId()));
    ...
    private final ModelResourcePermission<GuestbookTEntry> _guestbookTEntryModelResourcePermission;
    private GuestbookTEntry _entry;
