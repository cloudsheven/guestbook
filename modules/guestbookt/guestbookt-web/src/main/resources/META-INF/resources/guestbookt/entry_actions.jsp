...
<liferay-ui:icon-menu>
	<portlet:renderURL var="viewEntryURL">
    	...
    	<portlet:param name="mvcPath" value="/guestbookt/view_entry.jsp" />
	</portlet:renderURL>
	
	<liferay-ui:icon message="View" url="<%= viewEntryURL.toString() %>" />
	
	<c:if test="<%= GuestbookTEntryPermission.contains(
				permissionChecker, entry.getEntryId(), ActionKeys.UPDATE) %>">
	...
	<c:if test="<%=GuestbookTEntryPermission.contains(
        		permissionChecker, entry.getEntryId(), ActionKeys.PERMISSIONS) %>">
	...
	<c:if test="<%=GuestbookTEntryPermission.contains(
            		permissionChecker, entry.getEntryId(), ActionKeys.DELETE) %>">
