...
/**
 * Provides the local service interface for GuestbookT. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Andrea Luzzi
 * @see GuestbookTLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GuestbookTLocalService
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public GuestbookT addGuestbookT(GuestbookT guestbookT);
	...
	public GuestbookT createGuestbookT(long guestbookTId);
	...
	public GuestbookT deleteGuestbookT(GuestbookT guestbookT);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GuestbookT fetchGuestbookT(long guestbookTId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GuestbookT fetchGuestbookTByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GuestbookT getGuestbookT(long guestbookTId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GuestbookT getGuestbookTByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GuestbookT> getGuestbookTs(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GuestbookT> getGuestbookTsByUuidAndCompanyId(
