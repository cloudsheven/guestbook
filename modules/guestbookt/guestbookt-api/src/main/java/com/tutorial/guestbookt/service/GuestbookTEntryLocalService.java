...
/**
 * Provides the local service interface for GuestbookTEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Andrea Luzzi
 * @see GuestbookTEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GuestbookTEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.tutorial.guestbookt.service.impl.GuestbookTEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the guestbook t entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link GuestbookTEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public GuestbookTEntry createGuestbookTEntry(long entryId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public GuestbookTEntry deleteGuestbookTEntry(
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public GuestbookTEntry deleteGuestbookTEntry(long entryId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GuestbookTEntry fetchGuestbookTEntry(long entryId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GuestbookTEntry fetchGuestbookTEntryByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GuestbookTEntry> getGuestbookTEntries(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GuestbookTEntry> getGuestbookTEntriesByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GuestbookTEntry getGuestbookTEntry(long entryId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GuestbookTEntry getGuestbookTEntryByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
